// copied from react-native-video-controls 2.6.0
...
export default class VideoPlayer extends Component {
  ...
  _onBack() {
    if (this.props.navigation) {
      this.props.navigation.navigate('Dashboard', {data: this.props.data});
    } else {
      console.warn(
  ...
  renderTopControls() {
    ...
    return (
      <Animated.View
        ...
        <ImageBackground
          source={require('./assets/video-controls/top-vignette.png')}
  ...
  renderBack() {
    return this.renderControl(
      <Image
        source={require('./assets/video-controls/back.png')}
  ...
  renderBottomControls() {
    const currentTimeControl = this.props.disableTimer
      ? this.renderNullControl()
      : this.renderCurrentTime();
    const timeRemainingControl = this.props.disableTimer
      ? this.renderNullControl()
      : this.renderTimeRemaing();
    ...
    return (
      <Animated.View
        ...
        <ImageBackground
          source={require('./assets/video-controls/bottom-vignette.png')}
          style={[styles.controls.column]}
          imageStyle={[styles.controls.vignette]}>
          {seekbarControl}
          <SafeAreaView
  ...
  renderPlayPause() {
    let source =
      this.state.paused === true
        ? require('./assets/video-controls/play3x.png')
        : require('./assets/video-controls/pause3x.png');
    return this.renderControl(
      <Animated.View
        style={[
  ...
  renderFastForward() {
    return this.renderControl(
      <Animated.View
        ...
        <Image
          source={require('./assets/video-controls/forward.png')}
  ...
  renderRewind() {
    return this.renderControl(
      <Animated.View
        ...
        <Image
          source={require('./assets/video-controls/rewind.png')}
          style={{height: 30, width: 30, resizeMode: 'contain'}}
        />
      </Animated.View>,
      this.methods.rewind,
    ...
    if (this.state.loading) {
      return (
        <View style={styles.loader.container}>
          <Animated.Image
            source={require('./assets/video-controls/loader-icon.png')}
            style={[
              styles.loader.icon,
              {
                transform: [
    ...
    if (this.state.error) {
      return (
        <View style={styles.error.container}>
          <Image
            source={require('./assets/video-controls/error-icon.png')}
          ...
          {!this.state.loading && (
            <View
              style={{
                ...
                flexDirection: 'row',
                alignItems: 'center',
                justifyContent: this.props.disableRewind
                  ? this.props.disableFastForward
                    ? 'center'
                    : 'space-around'
                  : 'space-around',
              }}>
              {!this.props.disableRewind && this.renderRewind()}
              {!this.props.disablePlayPause && this.renderPlayPause()}
              {!this.props.disableFastForward && this.renderFastForward()}
            </View>
          )}
